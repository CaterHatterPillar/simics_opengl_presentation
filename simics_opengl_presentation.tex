...
\begin{document}
	...
	\subsection{Simics}
	\input{simics.tex}
        \input{hardwareassistedvirtualization.tex}

        \subsection{Terminology}
        \input{paravirtualization.tex}
	...
	\input{benchmarks.tex}
        ...
        \subsection{Results}
        \input{resultschess.tex}
        \input{resultsjulia.tex}

        \subsection{Hardware-assisted virtualization}
        \input{hardwareassistedvirtualizationresults.tex}
