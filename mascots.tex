...
% * QEMU should probably early on under Previous Research, but not expanded upon
%   in detail since it probably won't play as large of a role in the paper
%   compared to the thesis.
% * The section on magic instructions should not be put under Previous Research.
%   This should be described when detailing the paravirtualization methodology
%   used for this paper.
