...
Some virtual platforms provide advanced features such as reverse execution~\dvtcmdcitebib{publications:aarno:2014, journals:aarno:2013} (the ability to run a simulation backwards) and checkpointing~\dvtcmdcitebib{publications:aarno:2014, journals:aarno:2013} (functionality to save and restore the state of a simulation).
