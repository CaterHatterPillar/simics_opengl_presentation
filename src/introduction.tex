...
Typical methods include interpretation ~\dvtcmdcitebib[p.~35]{journals:smith:2005} (slowest), just-in-time compilation~\dvtcmdcitebib[p.~24,~25]{journals:aarno:2013}, and Hardware-assisted Virtualization ~\dvtcmdcitebib[p.~24,~25]{journals:aarno:2013}\dvtcmdcitebib[p.~38,~39]{publications:leupers:2010} (fastest).
