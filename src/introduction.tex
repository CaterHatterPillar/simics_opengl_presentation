...
\hl{There are a number of ways to do so, such as relying on PCI~passthrough and similar technologies to grant access to the underlying host hardware from within the virtual platform}~\dvtcmdcitebib[p.~415,~416]{inproceedings:regola:2010}, \hl{or utilizing a concept commonly referred to as "paravirtualization" at a higher level of abstraction, e.g., the graphics library.
...
% The rest of this paper is organized as follows. In section A, we present X. We present Y in section B, and finally Z in C.
