...
There are a number of ways to do so, such as relying on PCI~passthrough and similar technologies to grant access to the underlying host hardware from within the virtual platform~\dvtcmdcitebib[p.~415,~416]{inproceedings:regola:2010, web:jones:2009}, or utilizing a concept commonly referred to as 'Paravirtualization' at a higher level of abstraction (e.g., the graphics library).
