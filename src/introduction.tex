...
Paravirtualization has been used to accelerate graphics in the past; most notably, Lagar-Cavilla et al. accelerate OpenGL~$1.5$ up to two orders of magnitude~\masccite{inproceedings:lagarcavilla:2007} for WMware~Workstation and Xen VMMs.
To relieve communication bottlenecks, Lagar-Cavilla et al. suggests using a shared memory model~\masccite{inproceedings:lagarcavilla:2007} for target-to-host communications.
