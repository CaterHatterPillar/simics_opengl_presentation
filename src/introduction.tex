...
This paper presents the acceleration of OpenGL~ES~$2.0$ in the Simics full-system simulator, using magic instructions as a communications bridge between target and host systems.
