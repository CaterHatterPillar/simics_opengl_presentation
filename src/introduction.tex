...
In contrast to CPU-bound workloads, when developing software for GPUs, seemingly insignificant additions to code may cause significant changes in performance due to massively parallelized instruction sets\dvtcmdcitebib[ch.~6]{publications:kirk:2010}.
Since GPUs operate significantly different from CPUs, they pose unique challenges to designers and developers~\dvtcmdcitebib[ch.~13]{publications:kirk:2010}.
