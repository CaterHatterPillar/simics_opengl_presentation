...
We perform the Chess benchmark with $60\cdot60$, $84\cdot84$, and $118\cdot118$ tiles, which entails roughly $9\cdot60\cdot60$, $9\cdot84\cdot84$, and $9\cdot118\cdot118$ magic instructions per frame.
...
\subsection{Results}
\label{sec:results}
Results gathered from execution on the host are presented in table~\ref{tab:keyvalhost} and results accumulated from software rasterized and paravirtualized execution in Simics are presented in tables~\ref{tab:keyvalsimics}~and~\ref{tab:keyvalpara}.
...
\begin{table*}[ht] 
  ...
  \begin{minipage}[b]{0.5\linewidth}
    ...
    \begin{tabular}{|c|c|c|c|c|}
      \hline
      \multirow{2}{*}{Benchmark} & \multicolumn{4}{p{4cm}|}{\centering Elapsed time (\milli\second )} \\
