...
A prominent example of accelerated graphics in a virtual platform is presented by Lagar-Cavilla et al., who accelerates OpenGL~$1.5$ roughly two orders of magnitude using paravirtualization methodology~\dvtcmdcitebib{inproceedings:lagarcavilla:2007}.\todo{Elaborate here a bit on Lagar-Cavillas work. Proceed to explain your angle in the Problem Formulation section.}
